...
import CsVsCcScatterplot from "../cs-vs-cc-scatterplot/cs-vs-cc-scatterplot"
    ...
    render() {
        return (
            <div className="home">
                ...
                { this.state.match_data.length ? <CsVsCcScatterplot match_data={this.state.match_data}/> : <none/> }
